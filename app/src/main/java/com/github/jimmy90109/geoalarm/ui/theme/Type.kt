...
val GoogleSans = FontFamily(
    ...
    Font(googleFont = GoogleFont("Google Sans"), fontProvider = provider, weight = FontWeight.SemiBold)
)

// Uncomment below if you have the local Google Sans files in res/font/
/*
val GoogleSans = FontFamily(
